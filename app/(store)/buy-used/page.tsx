...
export default async function BuyUsedPage() {
  ...
  const conditionColors: any = { Excellent: '#1a8a4a', Good: '#0071e3', Fair: '#f59e0b', Poor: '#c8102e' }

  return (
    <div style={{ maxWidth: 1400, margin: '0 auto', padding: '48px 32px' }}>
      <div style={{ textAlign: 'center', marginBottom: 56 }}>
        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, textTransform: 'uppercase', color: '#c8102e', marginBottom: 8 }}>CERTIFIED REFURBISHED</div>
